...
type Props = {
    setProgramNewId: React.Dispatch<React.SetStateAction<number[]>>;
    compyuterDetailData: Compyuter | undefined
};

export default function PO({ setProgramNewId, compyuterDetailData }: Props) {
    ...
    useEffect(() => {
        ...
        setProgramNewId(allSelectedProgramIds);
